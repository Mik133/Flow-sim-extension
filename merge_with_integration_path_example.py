...
from flow.networks.merge_with_integration_path import MergeWithIntegrationPathNetwork, ADDITIONAL_NET_PARAMS


additional_net_params = ADDITIONAL_NET_PARAMS
# changing additional parameters of the network
# additional_net_params['integration_path_length'] = 60
...
flow_params = dict(
    ...
    env_name=AccelEnv,
    network=MergeWithIntegrationPathNetwork,
    simulator='traci',
    sim=sim_params,
    env=env_params,
    net=net_params,
